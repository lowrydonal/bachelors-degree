...
public class NoNotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_no_notifs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(NoNotificationsActivity.this, LoginActivity.class);
                intent.putExtra("lap_id", lapId);
                NoNotificationsActivity.this.startActivity(intent);
                return true;
        }
